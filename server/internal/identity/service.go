...
func (d *Domain) acceptInvitationSignupService(TenantID uint, memorialID uint, token string, email string, firstName string, lastName string, password string) error {
	var err error
	...
	existingUser, err := d.FindUserByEmail(nil, TenantID, email)
	if err != nil {
		return fmt.Errorf("acceptInvitationSignupService: %w", err)
	}
	if existingUser != nil {
...
func (d *Domain) acceptInvitationService(TenantID uint, memorialID uint, userID uint, token string) error {
	var err error
	...
	existingUser, err := d.FindUserByID(nil, TenantID, userID)
	if err != nil {
		return fmt.Errorf("acceptInvitationService: %w", err)
	}
	if existingUser == nil {
...
func (d *Domain) applicationSignupService(TenantID uint, memorialID uint, firstName string, lastName string, relationship schema.RelationshipConst, email string, password string) (*schema.Application, error) {
...
func (d *Domain) applicationService(TenantID uint, memorialID uint, applicantID uint, relationship schema.RelationshipConst) (*schema.Application, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) CreateFSPInvitation(TenantID uint, inviterID uint, inviteeEmail string, FSPRole schema.FSPRoleConst) (*schema.Invitation, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) CreateMemorialContributorInvitation(db *gorm.DB, TenantID uint, inviterID uint, inviteeEmail string, relationship schema.RelationshipConst, memorialID *uint) (*schema.Invitation, error) {
...
func (d *Domain) RefreshContributorInvitationAndToken(db *gorm.DB, TenantID uint, memorialID uint, invitationID uint) (*schema.Invitation, error) {
	// If db is nil, get the regular DB instance
	if db == nil {
		db = d.params.DB.GetDB()
	}
...
func (d *Domain) CreateMemorialContributorApplication(db *gorm.DB, TenantID uint, applicantID uint, memorialID uint, relationship schema.RelationshipConst, applicationType schema.ApplicationTypeConst) (*schema.Application, error) {
	// If db is nil, get the regular DB instance
	// this allows the function to be used in transactions
	if db == nil {
		db = d.params.DB.GetDB()
	...
	newApplication := schema.Application{
		TenantID:        TenantID,                        // TenantID 				uint
...
func (d *Domain) signinService(TenantID uint, email string, password string) (*schema.User, *rolesByLevel, error) {
	db := d.params.DB.GetDB()
	...
	rolesByLevel, err := d.QueryRolesByLevel(TenantID, existingUser.ID)
	if err != nil {
		return nil, nil, fmt.Errorf("signinService: %w", err)
	}
...
func (d *Domain) serviceSwitchActiveMemorial(TenantID uint, userID uint, targetMemorialID uint) (*rolesByLevel, error) {
	db := d.params.DB.GetDB()

	// Check if the user exists
	existingUser, err := d.FindUserByID(db, TenantID, userID)
	if err != nil {
	...
	rolesByLevel, err := d.QueryRolesByLevel(TenantID, userID)
	if err != nil {
		return nil, fmt.Errorf("switchActiveMemorialService: %w", err)
	}
...
func (d *Domain) signupService(TenantID uint, firstName *string, lastName *string, email string, password string) (*schema.User, error) {
	...
	// Create a new user with a default Tenant user role
...
func (d *Domain) confirmEmailService(TenantID uint, email string) error {
	db := d.params.DB.GetDB()
...
func (d *Domain) requestResetPasswordService(TenantID uint, email string) error {
	...
	// Check if the user exists
	_, err = d.FindUserByEmail(nil, TenantID, email)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
...
func (d *Domain) updatePasswordServiceWithoutConfirmation(TenantID uint, email string, password string) error {
	return d.updatePasswordServiceWithConfirmation(TenantID, email, password, false)
}
...
func (d *Domain) updatePasswordServiceWithConfirmation(TenantID uint, email string, password string, alsoConfirmAccount bool) error {
	db := d.params.DB.GetDB()
...
func (d *Domain) GeneratePasswordResetTokenAndPath(TenantID uint, email string) (*string, error) {
...
// !WARNING: It does *NOT* check if the user exists.
func (d *Domain) GenerateSetPasswordTokenAndPath(TenantID uint, email string) (*string, error) {
...
// Creates a new user and assigns the user a role at the Tenant level.
...
func (d *Domain) CreateUserAndFSPRole(db *gorm.DB, TenantID uint, firstName string, lastName string, email string, passwordHash *string, startingRole schema.FSPRoleConst) (*schema.User, error) {
	...
	err = db.Transaction(func(tx *gorm.DB) error {
		existingUser, err := d.FindUserByEmail(tx, TenantID, email)
		if err != nil {
...
// AssignOrUpdateFSPRole assigns or updates a user's role at the Tenant level.
...
func (d *Domain) AssignOrUpdateFSPRole(db *gorm.DB, TenantID uint, userID uint, roleToAssign schema.FSPRoleConst) (*schema.UserFSPRole, error) {
	var err error
	...
	// Check if user already has an Tenant-level role
	...
	// If No Tenant-level UserRole exists, create a new one with the given role
	...
	// If Tenant-level role exists, update the role
...
func (d *Domain) AssignOrUpdateMemorialRole(db *gorm.DB, TenantID uint, userID uint, memorialID uint, roleToAssign schema.MemorialRoleConst, relationship *schema.RelationshipConst) (*schema.UserMemorialRole, error) {
	// If db is nil, get the regular DB instance
	// this allows the function to be used in transactions
	if db == nil {
		db = d.params.DB.GetDB()
...
func (d *Domain) RemoveUserMemorialRoleByUserID(db *gorm.DB, TenantID uint, userID uint, memorialID uint) error {
	// If db is nil, get the regular DB instance
	// this allows the function to be used in transactions
	if db == nil {
		db = d.params.DB.GetDB()
...
func (d *Domain) RemoveUserMemorialRoleByID(db *gorm.DB, TenantID uint, userMemorialRoleID uint) error {
	// If db is nil, get the regular DB instance
	// this allows the function to be used in transactions
	if db == nil {
		db = d.params.DB.GetDB()
...
func (d *Domain) QueryRolesByLevel(TenantID uint, userID uint) (*rolesByLevel, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) FindUserFSPRole(db *gorm.DB, TenantID uint, userID uint) (*schema.UserFSPRole, error) {
	var err error
...
func (d *Domain) FindUserMemorialRoleByUserID(db *gorm.DB, TenantID uint, userID uint, memorialID uint) (*schema.UserMemorialRole, error) {
	var err error
...
func (d *Domain) FindUserMemorialRoleByID(db *gorm.DB, TenantID uint, userMemorialRoleID uint) (*schema.UserMemorialRole, error) {
	var err error
...
func (d *Domain) FindUserByEmail(db *gorm.DB, TenantID uint, email string) (*schema.User, error) {
	var err error
...
func (d *Domain) FindUserByID(db *gorm.DB, TenantID uint, userID uint) (*schema.User, error) {
	var err error
...
func (d *Domain) FindInvitationByToken(TenantID uint, memorialID uint, token string) (*schema.Invitation, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) FindInvitationByEmail(TenantID uint, memorialID uint, email string) (*schema.Invitation, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) FindContributorInvitationByEmail(TenantID uint, memorialID uint, email string) (*schema.Invitation, error) {
	var err error
...
func (d *Domain) FindContributorInvitationByID(TenantID uint, invitationID uint) (*schema.Invitation, error) {
	var err error
...
func (d *Domain) FindContributorApplicationByID(TenantID uint, applicationID uint) (*schema.Application, error) {
	var err error
...
func (d *Domain) FindContributorApplicationByEmail(TenantID uint, memorialID uint, email string) (*schema.Application, error) {
	var err error
	...
	err = db.
		...
		Where("applications.fsp_id = ?", TenantID).
...
func (d *Domain) FindContributorApplicationByApplicantID(TenantID uint, memorialID uint, applicantID uint) (*schema.Application, error) {
	var err error
...
func (d *Domain) FindMemorialByID(TenantID uint, memorialID uint) (*schema.Memorial, error) {
	var err error
...
// Checkers -------------------------------------------------------
func (d *Domain) UserHasMemorialRole(TenantID uint, userID uint, memorialID uint, role schema.MemorialRoleConst) (bool, error) {
	db := d.params.DB.GetDB()
...
func (d *Domain) UserHasFSPRole(TenantID uint, userID uint, role schema.FSPRoleConst) (bool, error) {
	db := d.params.DB.GetDB()
